...
namespace QRMenu.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,PostalCode,Address,Phone,StateId,Email,TaxNumber,WebAddress")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,PostalCode,Address,Phone,StateId,Email,RegisterDate,TaxNumber,WebAddress")] Company company)
        {
            if (id != company.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (company != null)
            {
                ...
                IQueryable<Restaurant> restaurants = _context.Restaurants.Where(r => r.CompanyId == company.Id);
