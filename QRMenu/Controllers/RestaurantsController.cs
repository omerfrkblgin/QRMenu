...
namespace QRMenu.Controllers
{
    public class RestaurantsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,StateId,CompanyId,Phone,PostalCode,Address,RegisterDate")] Restaurant restaurant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,StateId,CompanyId,Phone,PostalCode,Address,RegisterDate")] Restaurant restaurant)
        {
            if (id != restaurant.Id)
            {
                return NotFound();
